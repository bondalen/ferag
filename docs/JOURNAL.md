...
## 2026-01-29 — WSL2, диск D:, проект graph-rag-lab
...
- Создана структура: `~/projects/graph-rag-lab` в Ubuntu.
- Установлен Cursor, расширение WSL; подключение к Ubuntu; открытие папки `/home/alex/projects/graph-rag-lab` через File → Open Folder (т.к. команда `code .` в Ubuntu не находилась).
...
**Чат:** Инструкции по WSL, переносу на D:, созданию `graph-rag-lab`, открытию в Cursor, установке команды cursor, Cursor Agent CLI.
