...
- **Готовность рабочего процесса:** диалог с LLM по сохранённым данным (RAG) достигнут; ретривер привязан к словам вопроса. Следующие рубежи: улучшение индексации (полнота сущностей и описаний в графе), задел WebVOWL/Cytoscape (шаг 5 плана 26-0226-1455), затем экраны онтологии/графа и проекции (PostgreSQL/AGE/pgvector).
- **Чат по RAG в веб-приложении:** история в БД (chat_messages), сессии (chat_sessions, CRUD), выбранная сессия восстанавливается после F5. Запланировано: контекст диалога в LLM, сжатие длинных диалогов (9.13). Порядок: [PROJECT-004-chat-dialogue](PROJECT-004-chat-dialogue.md).
