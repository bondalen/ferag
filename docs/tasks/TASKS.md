...
| 9.5 | Реализовать `code/frontend/` — Vue 3 SPA | [ ] | Vite: base '/ferag/'; страницы: login, список RAG, загрузка файлов, диалог, приглашения. Целевой стек: Vue 3 + Vite + **Quasar** + **Pinia**; визуализация: **WebVOWL** (онтология), **Cytoscape.js** (граф инстансов). Миграция с текущего Vue 3 SPA — отдельный план/чат. [PROJECT-005](../project/PROJECT-005-frontend-visualization.md). |
